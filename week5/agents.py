...
class Discretizer(ObservationWrapper):
    ...
    def __init__(self, velocity_buckets: int, position_buckets: int) -> None:
        super().__init__()
    ...
    def observation(self, observation: np.ndarray) -> Tuple(int, int, int):
...
class DisceteSmartAgent(OrininalSmartAgent, DiscreteAgent):
    def __init__(self, velocity_buckets: int, position_buckets: int):
        super().__init__(velocity_buckets, position_buckets)
